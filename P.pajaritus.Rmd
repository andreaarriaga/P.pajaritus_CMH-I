...
El modelo utilizado es correcto, sin embargo la interpretación del análisis es incorrecta ya que  el modelo  lo que  de muestra es que el eje de variación de lo datos para todos loe indices  de degradacion tiene un efecto en conjunto  sobre  la diversidad alelica, lo que no significa que todas tengan un efecto significativo y  el mismo efecto sobre  y corresponde a la trampa estadística de Reporte selectivo   sobre la diversidad alelica del complejo       
